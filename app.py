...
def api_feed(user_id):
    ...
    return jsonify({'голод': new_val, 'message': 'Покормлен!'})
...
def api_play(user_id):
    ...
    return jsonify({'счастье': new_s, 'энергия': new_e, 'message': 'Поиграл!'})
...
def api_wash(user_id):
    ...
    return jsonify({'гигиена': new_val, 'message': 'Помыт!'})
...
def api_sleep(user_id):
    ...
    return jsonify({'энергия': new_val, 'message': 'Поспал!'})
...
def api_train(user_id):
    ...
    return jsonify({'дисциплина': new_val, 'message': 'Тренировка!'})
